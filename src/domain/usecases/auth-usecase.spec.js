...
const makeSut = () => {
  ...
  return { loadUserByEmailRepositorySpy, sut, encrypterSpy, tokenGeneratorSpy, updateAccessTokenRepositorySpy }
}
...
describe('Auth UseCase', () => {
  ...
  test('Should throw if invalid dependecies is provided', async () => {
